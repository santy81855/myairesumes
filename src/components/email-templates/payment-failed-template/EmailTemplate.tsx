...
export const FailedPaymentTemplate: React.FC<Readonly<EmailTemplateProps>> = ({
    ...
    <div>
        ...
        <p>
            ...
            to MyResumeHero Pro. As a valued member of MyResumeHero, we want to
        ...
        <ol>
            <li>
                Log in to your MyResumeHero account at{" "}
                <a href="https://myresumehero.com">MyResumeHero.com</a>
            </li>
        ...
        <p>
            ...
            exclusive features of MyResumeHero Pro. Failure to take action
            within 7 days will result in the downgrade of your account to the
            free plan.
        </p>
        <br />
