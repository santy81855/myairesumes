                ...
                <div data-custom-class="body">
                        ...
                        <span style={{ color: "rgb(127, 127, 127)" }}>
                            ...
                            >
                                <span data-custom-class="body_text">
                                    ...
                                    <strong>our</strong>") uses cookies and
                                    similar technologies to recognize you when
                            ...
                            >
                                <span data-custom-class="body_text">
                                    <bdt className="question">
                                        <a
                                            href="https://myresumehero.com"
                                            target="_blank"
                                            data-custom-class="link"
                                        >
                                            https://myresumehero.com
                                        </a>
                                    </bdt>
                                </span>
                            </span>
                            ...
                            >
                                <span data-custom-class="body_text">
                                    {" "}
                                    ("<strong>Website</strong>"). It explains
                        ...
                        <span style={{ color: "rgb(127, 127, 127)" }}>
                            ...
                            >
                                <span data-custom-class="body_text">
                                    ...
                                    or through the website (e.g., advertising,
                        ...
                        <span style={{ color: "rgb(127, 127, 127)" }}>
                            ...
                            >
                                <span data-custom-class="body_text">
                                    ...
                                    party cookies for several reasons. Some
                                    cookies are required for technical reasons
                                    in order for our Website to operate, and we
                    ...
                    <div style={{ lineHeight: "1.5" }}>
                        ...
                        >
                            ...
                            >
                                <span data-custom-class="body_text">
                                    The Cookie Consent Manager can be found in
                                    the notification banner and on our website.
                                    If you choose to reject cookies, you may
                                    still use our website though your access to
                                    some functionality and areas of our website
                                    may be restricted. You may also set or amend
                        ...
                        >
                            ...
                            >
                                <span data-custom-class="body_text">
                                    ...
                                    table below (please note that the
                                    specific&nbsp;
                                </span>
                                <span data-custom-class="body_text">
                    ...
                    <div style={{ lineHeight: "1.5" }}>
                        <span data-custom-class="body_text">
                            ...
                            your web browser controls vary from browser to
                            browser, you should visit your browser's help menu
                            for more information. The following is information
                            about how to manage cookies on the most popular
                            browsers:
                        </span>
                    </div>
                    <ul>
                    ...
                    <div style={{ lineHeight: "1.5" }}>
                        <span style={{ color: "rgb(127, 127, 127)" }}>
                            ...
                            >
                                ...
                                >
                                    <span data-custom-class="body_text">
                                        to recognize or track visitors to a
                                        website. We may use other, similar
                                        technologies from time to time, like web
                                        beacons (sometimes called "tracking
                                        pixels" or "clear gifs"). These are tiny
                                        graphics files that contain a unique
                                        identifier that enables us to recognize
                                    ...
                                    >
                                        ...
                                        >
                                            <span data-custom-class="body_text">
                                                ...
                                                from one page within a website
                                                to another, to deliver or
                                                communicate with cookies, to
                                                understand whether you have come
                                                to the website from an online
                                                advertisement displayed on a
                                                third-party website, to improve
                                                site performance, and to measure
                                                the success of email marketing
                                                campaigns. In many instances,
                                                these technologies are reliant
                                                on cookies to function properly,
                                                and so declining cookies will
                    ...
                    <div style={{ lineHeight: "1.5" }}>
                        ...
                        >
                            <span data-custom-class="body_text">
                                ...
                                computer, you can adjust the settings of your
                                Flash player to block Flash Cookies storage
                        ...
                        >
                            ...
                            >
                                <span data-custom-class="body_text">
                                    following the instructions (which may
                    ...
                    <div style={{ lineHeight: "1.5" }}>
                        ...
                        >
                            <span data-custom-class="body_text">
                                Third parties may serve cookies on your computer
                                or mobile device to serve advertising through
                                our Website. These companies may use information
                                about your visits to this and other websites in
                                order to provide relevant advertisements about
                                goods and services that you may be interested
                                in. They may also employ technology that is used
                                to measure the effectiveness of advertisements.
                                They can accomplish this by using cookies or web
                                beacons to collect information about your visits
                                to this and other sites in order to provide
                                relevant advertisements about goods and services
                                of potential interest to you. The information
                            ...
                            >
                                ...
                                >
                                    <span data-custom-class="body_text">
                                        ...
                                        order to reflect, for example, changes
                                        to the cookies we use or for other
                            ...
                            >
                                ...
                                >
                                    <span data-custom-class="body_text">
                                        ...
                                        of cookies or other technologies, please
                                        email us at{" "}
                                        <bdt className="question">
                                            santiago@santiagogarcia.dev
                                        </bdt>{" "}
                                        or by post to:
                                    </span>
                                </span>
                    ...
                    <div style={{ lineHeight: "1.5" }}>
                        <span data-custom-class="body_text">
                            ...
                            >
                                <bdt className="question">canton</bdt>
                                <bdt className="block-component" />
                                <bdt className="block-component" />,{" "}
                                ...
                                <bdt className="block-component" />
                                <bdt className="block-component" />{" "}
                                <bdt className="question">30114</bdt>
                                <bdt className="statement-end-if-in-editor" />
                                <bdt className="block-component" />
                                <bdt className="block-component" />
                                <bdt className="block-component" />
                    ...
                    <div style={{ lineHeight: "1.5" }}>
                        <span data-custom-class="body_text">
                            ...
                            >
                                <bdt className="statement-end-if-in-editor">
                                    Phone:{" "}
                                    <bdt className="question">6787359580</bdt>
                                </bdt>
                            </span>
                        </span>
                        <span data-custom-class="body_text">
